...
Alle Ressourcen sind so gesichert, dass nur authentifizierte Akteure auf diese zugreifen können. Die
...
JWTfootnote:jwt[JSON Web Token], das vom Client gespeichert werden sollte, um sich bei Zugriff auf Ressourcen zu autorisieren.
